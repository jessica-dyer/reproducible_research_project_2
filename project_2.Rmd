...
regions <- data.frame(region = "Central", state = c("IL", "IN",	"KY",	"MO",	"OH",	"TN",	"WV"))
east_n_central <- (data.frame(region = "East North Central", state = c("IA",	"MI",	"MN",	"WI")))
northeast <- (data.frame(region = "Northeast", state = c("CT",	"DE",	"ME",	"MD",	"MA",	"NH",	"NJ",	"NY",	"PA",	"RI",	"VT")))
northwest <- (data.frame(region = "Northwest", state =c("ID",	"OR",	"WA")))
south <- (data.frame(region = "South", state =c("AR",	"KS",	"LA",	"MS",	"OK",	"TX")))
southeast <- (data.frame(region = "Southeast", state =c("AL",	"FL",	"GA",	"NC",	"SC",	"VA")))
...
regions <- rbind(regions, east_n_central, northeast, northwest, south, southeast, southwest, west, west_n_central)
